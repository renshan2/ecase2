      ...
      <td class="ms-vb2" style="vertical-align: middle;" valign="middle">
        ...
        <xsl:if test="$ListRight_AddListItems = '1'">
          <div class="deleteicon">
            <a href="Lists/Owners/EditForm.aspx?ID={@ID}&amp;ContentTypeID=0x01005886DC9B59F8491E91DADDC768E67BAF00B99FC4D43BE7404A88CDACBDE37E9D89" onclick="javascript:DeleteItem({@ID},'Bureau');return false;">
    ...
    <tr>
      <td class="ms-vb" colspan="99">
        ...
        <xsl:if test="$ListRight_AddListItems = '1'">
          ...
          <xsl:text>To add a new item, click "Add New Owner".</xsl:text>
        </xsl:if>
      </td>
    </tr>
  </xsl:template>
