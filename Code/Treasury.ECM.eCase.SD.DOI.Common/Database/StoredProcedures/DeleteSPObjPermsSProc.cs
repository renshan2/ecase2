...
{
    public class DeleteSPObjPermsSProc : IeCaseStoredProc
    {
        private List<SqlParameter> parameters;
        public SqlParameter[] Parameters { get { return parameters.ToArray(); } }
        public string StoredProcedure { get { return "[dbo].[usp_DeleteSPObjectPermissions]"; } }
        public DeleteSPObjPermsSProc(Guid siteGuid, Guid caseWebGuid)
        {
