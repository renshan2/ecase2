...
<%-- CodeBehind="CaseData.aspx.cs" Inherits="Treasury.ECM.eCase.SusDeb.DOI.Web.CaseSiteDefinition.Modules.eCasePages.CaseDataPage, --%>
                ...
                <div id="tabs-wrapper">
                    <div id="tabs" class="ui-tabs ui-widget ui-widget-content ui-corner-all">
                        <ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all">
                            ...
                            <%--<li class="ui-state-default ui-corner-top ui-tabs-active ui-state-active"><a href="#tabs-3" class="ui-tabs-anchor">Case Data</a></li>--%>
                        ...
                        <div id="tabs-3" class="ui-tabs-panel ui-widget-content ui-corner-bottom">
                            <WebPartPages:WebPartZone ID="ID3" runat="server" Title="Zone Tab 3">
