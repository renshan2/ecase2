...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SearchBatchCopying.aspx.cs" Inherits="Treasury.ECM.eCase.SusDeb.DOI.Search.Layouts.eCaseSearch.SearchBatchCopying" DynamicMasterPageFile="~masterurl/default.master" %>
...
<asp:Content ID="PageHead" ContentPlaceHolderID="PlaceHolderAdditionalPageHead" runat="server">
    ...
    <style type="text/css">
        ...
        #ctl00_PlaceHolderMain_hidOtherLocationVisible { 
            display: none; 
        }
    </style>
</asp:Content>
...
<asp:Content ID="Main" ContentPlaceHolderID="PlaceHolderMain" runat="server">
    ...
    <table id="maintable" class="ms-propertysheet" border="0" cellspacing="0" cellpadding="0" width="100%">
        <tbody>
            <tr>
                <td class="ecase-copy-heading" colspan="2"><h2>Batch Copy Search Results</h2></td>
            </tr>
            <tr>
                            ...
                            <tr>
                                ...
                                <td class="ms-authoringcontrols">                                    
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="ms-authoringcontrols" width="100%">
                                                    <asp:TreeView runat="server" ID="treeView" RootNodeStyle-Font-Bold="true" OnSelectedNodeChanged="treeView_SelectedNodeChanged" ExpandDepth="0">
                                    ...
                                    <table id="table-enter-location" border="0" border="0" cellspacing="0" cellpadding="1">
                                        <tbody>
                                            <tr>
                                                <td class="ms-descriptiontext ms-inputformdescription">The destination must be a URL to a SharePoint document library or document set.<br />( Example: http://www.example.gov/sites/MyBureau/MyCase/Lists/CaseDocuments )<br />
                                                </td>                                                
                                            </tr>
                                            <tr>
                                                <td class="ms-authoringcontrols">
