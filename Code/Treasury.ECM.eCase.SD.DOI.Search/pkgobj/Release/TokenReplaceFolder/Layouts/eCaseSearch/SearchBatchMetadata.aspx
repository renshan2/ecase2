...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SearchBatchMetadata.aspx.cs" Inherits="Treasury.ECM.eCase.SusDeb.DOI.Search.Layouts.eCaseSearch.SearchBatchMetadata" DynamicMasterPageFile="~masterurl/default.master" %>

<asp:Content ID="PageHead" ContentPlaceHolderID="PlaceHolderAdditionalPageHead" runat="server">
</asp:Content>
<asp:Content ID="Main" ContentPlaceHolderID="PlaceHolderMain" runat="server">
    <b><asp:Label runat="server" ID="lblInstructions" /></b><br />
                        ...
                        <tbody>
                            <tr>
                                <td style="PADDING-TOP: 4px" class="ms-sectionheader" height="22" valign="top">
                                    <h3 class="ms-standardheader ms-inputformheader">Common Fields </h3>
                                </td>
                            </tr>
                            <tr>
                                <td class="ms-descriptiontext ms-inputformdescription">These are the fields that each selected list have in common. Entering a value in these fields and then choosing save will update the field value for ALL selected lists.</td>
                                <td>
                                                ...
                                                <tr id="ctl00_PlaceHolderMain_ctl00_ctl04_tablerow3">
                                                    ...
                                                    <td class="ms-authoringcontrols" width="99%">
                                                        <table border="0" cellspacing="1">
                                                            <tbody>
                                                                <asp:PlaceHolder ID="phDynamicFormControls" runat="server" />
                                                            </tbody>
                                                        </table>
                                                    </td>
                                                </tr>
                    ...
                    <table cellspacing="0" cellpadding="0" width="100%">
                        ...
                        <tbody>
                            <tr>
                                <td>&nbsp;</td>
                                <td nowrap>
                                    <asp:Button runat="server" ID="btnSave" class="ms-ButtonHeightWidth" Text="Save" OnClick="btnSave_Click" />&nbsp;<asp:Button runat="server" CausesValidation="false" class="ms-ButtonHeightWidth" ID="btnCancel" Text="Cancel" OnClick="btnCancel_Click" />
                                </td>
                            </tr>
                        </tbody>
                    </table>
...
<asp:Content ID="PageTitle" ContentPlaceHolderID="PlaceHolderPageTitle" runat="server">
    Batch Metadata Export Search Results
</asp:Content>
