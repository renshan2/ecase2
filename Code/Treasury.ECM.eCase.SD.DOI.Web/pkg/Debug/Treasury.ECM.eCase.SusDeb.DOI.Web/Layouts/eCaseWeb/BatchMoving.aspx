...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BatchMoving.aspx.cs" Inherits="Treasury.ECM.eCase.SusDeb.DOI.Web.Layouts.Treasury.ECM.eCase.SusDeb.DOI.Web.BatchMoving" DynamicMasterPageFile="~masterurl/default.master" %>
                    ...
                    <table cellspacing="0" cellpadding="0" width="100%">
                        ...
                        <tbody>
                            <tr>
                                <td>&nbsp;</td>
                                <td nowrap>
                                    <asp:Button runat="server" ID="btnValidate" class="ms-ButtonHeightWidth" Text="Validate Files" OnClick="btnValidate_Click" />&nbsp;<asp:Button class="ms-ButtonHeightWidth" runat="server" ID="btnSave" Text="OK" OnClick="btnSave_Click" />&nbsp;<asp:Button class="ms-ButtonHeightWidth" runat="server"  CausesValidation="false" ID="btnCancel" Text="Cancel" OnClick="btnCancel_Click" />
                                </td>
                            </tr>
                        </tbody>
                    </table>
