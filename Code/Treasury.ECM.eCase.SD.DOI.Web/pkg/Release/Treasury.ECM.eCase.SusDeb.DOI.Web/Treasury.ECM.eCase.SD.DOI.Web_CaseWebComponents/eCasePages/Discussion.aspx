...
<%-- CodeBehind="Discussion.aspx.cs" Inherits="Treasury.ECM.eCase.SusDeb.DOI.Web.CaseSiteDefinition.Modules.eCasePages.DiscussionPage, --%>
                ...
                <div id="tabs-wrapper">
                    <div id="tabs" class="ui-tabs ui-widget ui-widget-content ui-corner-all">
                        <ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all">
                            ...
                            <li class="ui-state-default ui-corner-top ui-tabs-active ui-state-active"><a href="#tabs-5" class="ui-tabs-anchor">Discussion</a></li>
                        </ul>
                        <div id="tabs-5" class="ui-tabs-panel ui-widget-content ui-corner-bottom">
                            <WebPartPages:WebPartZone ID="ID5" runat="server" Title="Zone Tab 5">
