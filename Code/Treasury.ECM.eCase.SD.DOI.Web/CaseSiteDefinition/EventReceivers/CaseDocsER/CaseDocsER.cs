...
using Treasury.ECM.eCase.SusDeb.DOI.Web.CaseSiteDefinition.EventReceivers;

namespace Treasury.ECM.eCase.SusDeb.DOI.Web.CaseSiteDefinition.EventReceivers.CaseDocsER
{
    /// <summary>
    /// List Item Events
    /// </summary>
    public class CaseDocsER : SPItemEventReceiver
    {
