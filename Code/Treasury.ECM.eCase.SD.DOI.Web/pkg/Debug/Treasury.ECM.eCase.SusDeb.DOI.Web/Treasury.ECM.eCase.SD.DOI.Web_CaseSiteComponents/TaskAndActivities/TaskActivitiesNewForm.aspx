...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TaskActivitiesNewForm.aspx.cs" Inherits="Treasury.ECM.eCase.SusDeb.DOI.Web.Layouts.Treasury.ECM.eCase.SusDeb.DOI.Web.TaskActivitiesNewForm" MasterPageFile="~masterurl/default.master" %>
...
<asp:Content ContentPlaceHolderId="PlaceHolderAdditionalPageHead" runat="server">
    ...
    <script type="text/javascript">
        ...
        function CaseFormReadyFunction() {
            var fldStartDate = $("input[title='Start Date']");
            if (fldStartDate.length) {
                var txtStartDate = fldStartDate.val();
                // Populate "Due Date" field with "Start Date" field value
                $("input[title='Due Date']").val(txtStartDate);
            }
        }
    </script>
</asp:Content>
