...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SearchBatchMoving.aspx.cs" Inherits="Treasury.ECM.eCase.SusDeb.DOI.Search.Layouts.eCaseSearch.SearchBatchMoving" DynamicMasterPageFile="~masterurl/default.master" %>
                ...
                <td class="ms-descriptiontext" valign="top">
                    <table border="0" cellspacing="0" cellpadding="1" width="100%">
                        <tbody>
                            ...
                            <tr>
                                <td class="ms-descriptiontext ms-inputformdescription">Specify a destination - the destination must be a URL to a SharePoint document library or document set.<br>
                                    <br>
                                    By using the 'Move' option, your document metadata will be maintained.</td>
                                <td>
                    ...
                    <table cellspacing="0" cellpadding="0" width="100%">
                        ...
                        <tbody>
                            <tr>
                                <td>&nbsp;</td>
                                <td nowrap>
                                    <asp:Button runat="server" ID="btnValidate" class="ms-ButtonHeightWidth" Text="Validate Files" OnClick="btnValidate_Click" />&nbsp;<asp:Button runat="server" ID="btnSave" class="ms-ButtonHeightWidth" Text="Move" OnClick="btnSave_Click" />&nbsp;<asp:Button runat="server" CausesValidation="false" class="ms-ButtonHeightWidth" ID="btnCancel" Text="Cancel" OnClick="btnCancel_Click" />
                                </td>
                            </tr>
                        </tbody>
                    </table>
